...
import { studentService, StudentById, updateStudent, getClasses, Class } from '@/app/services/student.service';
...
const EditStudentProfile = () => {
  ...
  const handleInputChange = (field: string, value: string | boolean | string[], section?: string) => {
    if (!student) return;
                      ...
                      <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleInputChange('dateOfBirth', e.target.value, 'userId')}
                          />
                        </div>
                  ...
                  <TabsContent value="parent-guardian" className="space-y-8 mt-0">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">Edit contact information for student's parent or guardian</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => handleInputChange('fullName', e.target.value, 'parentContact')}
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => handleInputChange('relationship', value, 'parentContact')}
                        >
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => handleInputChange('phoneNumber', e.target.value, 'parentContact')}
                          placeholder="Enter phone number"
                        />
                      </div>
                  ...
                  <TabsContent value="settings" className="space-y-8 mt-0">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">Manage student account settings and status</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) => handleBooleanChange('isActive', value === 'active')}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
