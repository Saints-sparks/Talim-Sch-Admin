              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <TabsContent value="personal-details" className="space-y-8 mt-0">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">View and manage student's personal details</p>
                      </div>
                    </div>
                  ...
                  <TabsContent value="parent-guardian" className="space-y-8 mt-0">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">Contact information for student's parent or guardian</p>
                      </div>
                    </div>
                  ...
                  <TabsContent value="academic-info" className="space-y-8 mt-0">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mt-1">Student's academic details and class information</p>
                      </div>
                    </div>
                  ...
                  <TabsContent value="attendance" className="space-y-8 mt-0">
                    <div className="flex items-center justify-between">
                      <div>
                        <h2 className="text-2xl font-bold text-gray-900">Attendance Information</h2>
                        <p className="text-gray-600 mt-1">Student's attendance record and status</p>
                      </div>
                    </div>
