        ...
        <section className="bg-white shadow rounded p-6">
          ...
          {isLoading && classes.length === 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <button
                className="mt-4 px-4 py-2 bg-[#154473] text-white rounded hover:bg-blue-700"
                onClick={toggleModal}
              >
                ...
                <tbody>
                  {displayedClasses.map((item, index) => (
                    <tr key={index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-2 px-4">{item.classCapacity || 'N/A'}</td>
                      <td className="py-2 px-4">{item.classDescription || 'N/A'}</td> 
                      <td className="py-2 px-4">
   

                         <button 
                          onClick={() => router.push(`/classes/view-class/${item._id}`)}
