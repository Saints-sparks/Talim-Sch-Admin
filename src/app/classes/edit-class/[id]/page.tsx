                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border-t border-gray-200 pt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          ...
                          <div className="bg-[#003366]/5 rounded-lg p-6 border border-[#003366]/20">
                            <div className="flex items-center justify-between">
                              <div>
                                <p className="text-sm font-medium text-[#003366]">
                                  Class Teacher
                                </p>
                                <p className="text-lg font-bold text-[#003366] truncate">
                  ...
                  <div className="p-6">
                    <div className="space-y-6">
                      ...
                      {classData.classTeacherId?.userId && (
                        <div className="bg-[#003366]/5 border border-[#003366]/20 rounded-xl p-6 mb-6">
                          ...
                          <div className="flex items-center gap-6">
                            ...
                            <div className="flex-1">
                              <h4 className="text-xl font-bold text-[#003366] mb-1">
                                {getCurrentTeacherName()}
                              </h4>
                              <p className="text-[#003366]/80 font-medium mb-2">
                      ...
                      <div className="flex justify-end pt-4 border-t border-gray-200">
                        <button
                          ...
                          className="flex items-center px-6 py-3 bg-[#003366] text-white rounded-lg hover:bg-[#002244] disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                        >
                          {isAssigningTeacher ? (
                            <>
