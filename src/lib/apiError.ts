...
const KNOWN_CODES = new Set<ApiErrorCode>([
  "UNAUTHENTICATED", "TOKEN_EXPIRED", "FORBIDDEN", "TENANT_MISMATCH", "VALIDATION_FAILED",
...
/** Fallback user-facing messages per HTTP status, for servers that return no message. */
