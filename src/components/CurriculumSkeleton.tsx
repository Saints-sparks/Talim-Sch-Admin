...
/**
 * The curriculum dashboard's loading state.
 *
 * Mirrors the real screen so the layout does not jump when the data lands.
 *
 * @returns The skeleton.
 */
const CurriculumSkeleton: React.FC = () => {
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 animate-pulse">
          ...
          <div className="px-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden mb-8">
              <div className="px-6 py-4 border-b border-gray-100 dark:border-slate-800 flex items-center gap-2">
                ...
                <div className="h-10 w-28 bg-gray-100 dark:bg-slate-800 rounded-xl" />
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden mb-8">
              ...
              <div className="px-6 py-5 border-b border-gray-100 dark:border-slate-800 flex items-center gap-2">
                <div className="h-5 w-5 bg-gray-200 dark:bg-slate-800 rounded" />
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-5 border-2 border-gray-100 dark:border-slate-800 rounded-xl"
                  >
                    <div className="flex items-center gap-4">
                      <div className="p-3 bg-gray-200 dark:bg-slate-800 rounded-xl h-12 w-12" />
                      <div className="space-y-2">
                        <div className="h-4 w-24 bg-gray-200 dark:bg-slate-800 rounded" />
                        <div className="h-3 w-32 bg-gray-100 dark:bg-slate-800 rounded" />
                      </div>
                    </div>
                    <div className="h-5 w-5 bg-gray-100 dark:bg-slate-800 rounded" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden mb-8">
              ...
              <div className="px-6 py-5 border-b border-gray-100 dark:border-slate-800 flex items-center gap-2">
                <div className="h-5 w-5 bg-gray-200 dark:bg-slate-800 rounded" />
                <div className="h-5 w-44 bg-gray-200 dark:bg-slate-800 rounded" />
              </div>
              {/* 5 content rows */}
              <div className="p-6 space-y-3">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 border border-gray-100 dark:border-slate-800 rounded-xl"
                  >
                    <div className="flex items-center gap-4 flex-1">
                      <div className="p-3 bg-gray-200 dark:bg-slate-800 rounded-xl h-11 w-11 flex-shrink-0" />
                    ...
                    <div className="h-7 w-24 bg-gray-100 dark:bg-slate-800 rounded-lg flex-shrink-0 ml-4" />
                  </div>
                ))}
              </div>
            </div>
